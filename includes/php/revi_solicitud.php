                         ...
                         <table width="600" border="0" id="pan_add_revision" class="table responsive" cellpadding="1" cellspacing="4">
                           ...
                           <tr>
                             <td height="46"><select name="select" id="cod_estado" class="form-control">
                               ...
                               <option value="36">Cedula (Corregido)</option>
                               <option value="37">Nombre del cliente (Corregido)</option>
                               <option value="38">Telefono (Corregido)</option>
                               <option value="39">Ciudad (Corregido)</option>
                               <option value="40">Barrio (Corregido)</option>
                               <option value="41">Servicio Incorrecto (Corregido)</option>
                               <option value="42">Servicio No aparece (Corregido)</option>
                                <option value="" disable='disabled'>----------------------</option> 
                               <option value="43">No se puede</option>
                               <option value="44">Nombre del cliente (Corregido)</option>
                               <option value="45">Telefono (Corregido)</option>
                               <option value="46">Ciudad (Corregido)</option>
                               <option value="47">Barrio (Corregido)</option>
                               <option value="48">Servicio Incorrecto (Corregido)</option>
                               <option value="49">Servicio No aparece (Corregido)</option>
                             </select></td>
