...
<script src="js/colorbox-master/jquery.colorbox-min.js"></script>
 <header class="page-header">
            <div class="container-fluid">
              <h2 class="no-margin-bottom">Dashboard (Financiera) </h2>
            </div>
          </header>
                      ...
                      <table width="813" border="0" align="center" class="table responsive">
                        ...
                        <tr>
                          ...
                          <td><select name="select2" id="tipo_informe" class='form-control'>
                            <option value="1">Sin Graficos</option>
                          </select></td>
        ...
        zIndex: 2048,
          format: 'yyyy-mm-dd'
            ...
            var tipo_informe=$("#tipo_informe").val();
                ...
                var datos='gene_dash_direct3='+1+'&fecha_1='+fecha_1+'&fecha_2='+fecha_2+'&ciudad='+ciudad+'&tipo_informe='+tipo_informe;
